...
public class ArbolLibros<T> {
    ...
    /**
     * metodo que retorna una lista preordenada
     * @param nodo que es de tipo Nodo
     * @return outArray con la lista preordenada
     */
    ...
    /**
     * Metodo que obtiene el arbol balanceado
     * @param node de tipo Nodo
